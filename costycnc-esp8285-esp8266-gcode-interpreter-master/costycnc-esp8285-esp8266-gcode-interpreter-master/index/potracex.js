...
function getSVG1(size, opt_type) {
  var maxx=0,maxxy=0,maxx0=0,maxy0=0,xx=0,yy=0;
size=size * .264;
    function path(curve) {
    
      function bezier(i) {
      maxx= (curve.c[i * 3 + 0].x * size).toFixed(3); 
      maxy =  (curve.c[i * 3 + 0].y * size).toFixed(3); 
      var b = 'G01 X' + maxx + ' Y' + maxy + '\n';  
      xx=parseInt(maxx,10);
      yy = parseInt(maxy,10); 
      ...
      maxx= (curve.c[i * 3 + 1].x * size).toFixed(3); 
      maxy =  (curve.c[i * 3 + 1].y * size).toFixed(3); 
      b += 'G01 X' + maxx + ' Y' + maxy + '\n';   
      xx=parseInt(maxx,10);
      yy = parseInt(maxy,10); 
      if(xx > maxx0) maxx0=xx;
      ...
      maxx= (curve.c[i * 3 + 2].x * size).toFixed(3); 
      maxy =  (curve.c[i * 3 + 2].y * size).toFixed(3); 
      b += 'G01 X' + maxx + ' Y' + maxy + '\n';   
      xx=parseInt(maxx,10);
      yy = parseInt(maxy,10); 
      if(xx > maxx0) maxx0=xx;
      ...
      var p ='G01 X'+(curve.c[0].x * size ).toFixed(3)+' Y0\n';
      var m = 'G01 X' + (curve.c[0].x * size).toFixed(3) +
          ' Y' + (curve.c[0].y * size).toFixed(3) + '\n';
 ...
 alert("Dimension "+maxx0+"mm x "+maxy0+"mm");
      return p;
    }
